(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('firstjhipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-firstjhipsterApp-error');
                var entityKey = httpResponse.headers('X-firstjhipsterApp-params');
                if (errorHeader) {
